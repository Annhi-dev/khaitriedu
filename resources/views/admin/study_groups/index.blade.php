...
@section('content')
<div class="space-y-6">
    <x-admin.page-header title="Quản lý nhóm học" subtitle="Danh sách này bám theo bảng danh mục và đếm đúng số khóa học thực tế đang nằm trong từng nhóm.">
    ...
    <x-admin.filter-bar route="{{ route('admin.categories') }}" searchPlaceholder="Tên, slug, mô tả..." :statuses="['active' => 'Hoạt động', 'inactive' => 'Ngừng hoạt động']" />
            ...
            <table class="min-w-full divide-y divide-slate-200">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50 transition">
                        ...
                        <td class="px-6 py-4">
                            <x-admin.badge :type="$category->status === 'active' ? 'success' : 'warning'" :text="$category->statusLabel()" />
                        </td>
                        <td class="px-6 py-4">
