        ...
        <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div class="mt-5 grid gap-4 md:grid-cols-2">
                <div class="md:col-span-2">
                    ...
                    <input id="name" name="name" value="{{ old('name', $category->name ?? '') }}" placeholder="Ví dụ: Ngoại ngữ - Tin học" class="w-full rounded-2xl border border-slate-300 px-4 py-3 text-sm text-slate-900 focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-100" />
                    @error('name')<p class="mt-2 text-sm text-rose-600">{{ $message }}</p>@enderror
                </div>

                <div class="md:col-span-2">
                    <label for="slug" class="mb-2 block text-sm font-medium text-slate-700">Slug</label>
                    <input id="slug" name="slug" value="{{ old('slug', $category->slug ?? '') }}" placeholder="Để trống nếu muốn tạo tự động theo tên" class="w-full rounded-2xl border border-slate-300 px-4 py-3 text-sm text-slate-900 focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-100" />
                ...
                <div>
                    ...
                    <input id="program" name="program" value="{{ old('program', $category->program ?? '') }}" placeholder="Tổng quát, thiếu nhi, luyện thi..." class="w-full rounded-2xl border border-slate-300 px-4 py-3 text-sm text-slate-900 focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-100" />
                ...
                <div>
                    ...
                    <input id="level" name="level" value="{{ old('level', $category->level ?? '') }}" placeholder="Cơ bản, nâng cao, A1, B1..." class="w-full rounded-2xl border border-slate-300 px-4 py-3 text-sm text-slate-900 focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-100" />
