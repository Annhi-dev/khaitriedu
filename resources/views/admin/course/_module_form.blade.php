...
<div class="grid gap-4 md:grid-cols-2">
    <div class="md:col-span-2">
        ...
        <input id="title" name="title" value="{{ old('title', $module->title ?? '') }}" placeholder="Ví dụ: Làm quen với bộ công cụ" class="w-full rounded-2xl border border-slate-300 px-4 py-3 text-sm text-slate-900 focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-100" />
    ...
    <div class="md:col-span-2">
        ...
        <textarea id="content" name="content" rows="5" placeholder="Tóm tắt mục tiêu và nội dung chính của module" class="w-full rounded-2xl border border-slate-300 px-4 py-3 text-sm text-slate-900 focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-100">{{ old('content', $module->content ?? '') }}</textarea>
