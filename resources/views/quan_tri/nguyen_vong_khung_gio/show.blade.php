...
@section('content')
<div class="space-y-6">
    <x-quan_tri.tieu_de_trang title="Chi tiết nguyện vọng slot" subtitle="Xem đầy đủ học viên đã chọn những slot nào và thứ tự ưu tiên của từng lựa chọn.">
        <x-slot name="actions">
                ...
                @forelse ($choices as $choice)
                    <div class="rounded-2xl border border-slate-200 p-4">
                        <div class="flex flex-wrap items-center justify-between gap-3">
                            ...
                            <x-quan_tri.huy_hieu type="info" :text="$choice->courseTimeSlot?->statusLabel() ?? 'Chưa cấu hình'" />
                        </div>
            ...
            <section class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                ...
                <div class="mt-4 space-y-4 text-sm text-slate-600">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <x-quan_tri.huy_hieu type="info" :text="$slotRegistration->statusLabel()" />
                        </div>
                    </div>
                    <div>
