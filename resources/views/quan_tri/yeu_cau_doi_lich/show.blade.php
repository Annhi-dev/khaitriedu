...
@php
    $badgeClasses = match ($scheduleChangeRequest->status) {
        \App\Models\YeuCauDoiLich::STATUS_APPROVED => 'border-emerald-200 bg-emerald-50 text-emerald-700',
        \App\Models\YeuCauDoiLich::STATUS_REJECTED => 'border-rose-200 bg-rose-50 text-rose-700',
