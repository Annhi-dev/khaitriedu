...
@section('content')
<div class="space-y-6">
    <x-quan_tri.tieu_de_trang title="Quản lý ứng tuyển giảng viên" subtitle="Duyệt hồ sơ ứng tuyển" />

    <x-quan_tri.thanh_loc route="{{ route('admin.teacher-applications') }}" searchPlaceholder="Tên, email, kinh nghiệm..." :statuses="['pending' => 'Chờ duyệt', 'approved' => 'Đã duyệt', 'rejected' => 'Từ chối', 'needs_revision' => 'Cần bổ sung']" />
            ...
            <table class="min-w-full divide-y divide-slate-200">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50 transition">
                        ...
                        <td class="px-5 py-4">
                            <x-quan_tri.huy_hieu :type="match($app->status) {'pending'=>'warning','approved'=>'success','rejected'=>'danger','needs_revision'=>'info', default=>'default'}" :text="$app->statusLabel()" />
                        </td>
