...
@section('content')
<div class="space-y-6">
    <x-quan_tri.tieu_de_trang title="Chi tiết học viên" subtitle="Thông tin cá nhân và hoạt động học tập">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 bg-white rounded-2xl border border-slate-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div><p class="text-sm text-slate-500">Trạng thái</p><x-quan_tri.huy_hieu :type="match($student->status) {'active'=>'success','inactive'=>'warning','locked'=>'danger', default=>'default'}" :text="$student->statusLabel()" /></div>
