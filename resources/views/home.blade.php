                ...
                <a href="{{ route('courses.index', ['category' => $category->slug]) }}" class="group">
                    <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 text-center border border-gray-100 group-hover:-translate-y-2">
                        ...
                        <div class="mt-2 text-[11px] font-semibold uppercase tracking-wider text-primary">
                            {{ $category->subjects_count }} khóa học
                        </div>
                    </div>
                </a>
            @empty
                            ...
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-2 gap-3 mb-4 pb-4 border-b">
                                    <div class="text-center rounded-xl bg-blue-50 p-3">
                                        <div class="text-lg font-bold text-primary">{{ $course->enrollments_count ?? 0 }}</div>
                                        <div class="text-xs text-gray-500">Đăng ký</div>
                                    </div>
                                    <div class="text-center rounded-xl bg-slate-50 p-3">
                                        <div class="text-lg font-bold text-primary">{{ $course->courses_count ?? 0 }}</div>
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    ...
                                    <a href="{{ route('khoa-hoc.show', $course->id) }}" class="flex-1 text-center bg-gradient-to-r from-primary to-primary-dark hover:from-primary-dark hover:to-primary text-white py-2 rounded-lg font-bold transition transform hover:scale-105 shadow-lg flex items-center justify-center gap-2 text-sm">
                                        <span>Xem</span>
