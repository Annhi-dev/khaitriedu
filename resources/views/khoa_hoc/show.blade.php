@php
  $courseLayout = 'bo_cuc.ung_dung';

  if ($user?->isStudent()) {
      $courseLayout = 'bo_cuc.hoc_vien';
  } elseif ($user?->isTeacher()) {
      $courseLayout = 'bo_cuc.giao_vien';
  } elseif ($user?->isAdmin()) {
      $courseLayout = 'bo_cuc.quan_tri';
  }
@endphp
