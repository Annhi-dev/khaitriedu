...
<div class="max-w-md mx-auto">
    <div class="card bg-white p-8 rounded-2xl shadow-md">
        ...
        <p class="text-sm text-center mt-4">
            Đã có tài khoản? <a href="<?php echo e(route('login')); ?>" class="text-primary hover:underline">Đăng nhập</a>
        </p>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XXamp\htdocs\khaitriedu\resources\views\auth\register.blade.php ENDPATH**/ ?>