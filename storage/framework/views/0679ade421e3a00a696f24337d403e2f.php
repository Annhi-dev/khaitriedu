...
<?php $__env->startSection('title', 'Trung tâm trợ giúp - KhaiTriEdu'); ?>
...
<div class="container mx-auto px-4 py-20">
    ...
    <div class="mt-20 bg-gradient-to-r from-blue-900 to-blue-700 text-white rounded-2xl p-12 text-center">
        ...
        <a href="<?php echo e(route('contact')); ?>" class="inline-block bg-white text-primary px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">
            Gửi tin nhắn
        </a>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XXamp\htdocs\khaitriedu\resources\views\pages\help.blade.php ENDPATH**/ ?>