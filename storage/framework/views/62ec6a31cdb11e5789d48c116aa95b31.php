<?php $__env->startSection('title', 'Giới thiệu - KhaiTriEdu'); ?>
...
<div class="container mx-auto px-4 py-20">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center mb-20 bg-blue-50 p-12 rounded-2xl">
        <div>
            <div class="text-4xl font-bold text-primary mb-2"><?php echo e(number_format($studentCount)); ?>+</div>
            <div class="text-gray-600">Học viên</div>
        </div>
        <div>
            <div class="text-4xl font-bold text-primary mb-2"><?php echo e(number_format($courseCount)); ?>+</div>
            <div class="text-gray-600">Khóa học</div>
        </div>
        <div>
            <div class="text-4xl font-bold text-primary mb-2"><?php echo e(number_format($teacherCount)); ?>+</div>
    ...
    <div class="mb-20">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden text-center">
                <img src="https://randomuser.me/api/portraits/men/<?php echo e(rand(1,50)); ?>.jpg" alt="Trainer" class="w-full h-64 object-cover">
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-1">Giảng viên #<?php echo e($i); ?></h3>
    ...
    <div class="bg-gradient-to-r from-blue-900 to-blue-700 rounded-3xl p-12 text-center text-white">
        ...
        <a href="<?php echo e(route('courses.index')); ?>" class="inline-block bg-white text-primary px-8 py-4 rounded-xl font-semibold hover:bg-gray-100 transition">
            Xem khóa học
        </a>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XXamp\htdocs\khaitriedu\resources\views\pages\about.blade.php ENDPATH**/ ?>