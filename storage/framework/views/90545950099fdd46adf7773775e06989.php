    ...
    <section class="rounded-[28px] bg-slate-950 p-6 text-white shadow-xl shadow-slate-900/10">
        <div class="flex flex-wrap items-start justify-between gap-4">
            ...
            <div class="rounded-3xl border border-white/10 bg-white/5 px-5 py-4 text-sm text-slate-200">
                ...
                <p class="mt-2 text-lg font-semibold"><?php echo e($user->name); ?></p>
        ...
        <div class="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-semibold text-slate-900"><?php echo e($studentCount); ?></p>
                </div>
        ...
        <div class="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-semibold text-slate-900"><?php echo e($teacherCount); ?></p>
                </div>
        ...
        <div class="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-semibold text-slate-900"><?php echo e($pendingTeacherApplications); ?></p>
                </div>
        ...
        <div class="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-semibold text-slate-900"><?php echo e($pendingEnrollments); ?></p>
                </div>
        ...
        <div class="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-semibold text-slate-900"><?php echo e($activeClassCount); ?></p>
                </div>
        ...
        <div class="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-semibold text-slate-900"><?php echo e($pendingScheduleChangeRequests); ?></p>
                </div>
    ...
    <section class="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
        <div class="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            ...
            <div class="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
                <a href="<?php echo e(route('admin.teacher-applications')); ?>" class="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 transition hover:border-cyan-300 hover:bg-cyan-50">
                ...
                <a href="<?php echo e(route('admin.enrollments')); ?>" class="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 transition hover:border-cyan-300 hover:bg-cyan-50">
                ...
                <a href="<?php echo e(route('admin.categories')); ?>" class="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 transition hover:border-cyan-300 hover:bg-cyan-50">
                ...
                <a href="<?php echo e(route('admin.subjects')); ?>" class="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 transition hover:border-cyan-300 hover:bg-cyan-50">
                ...
                <a href="<?php echo e(route('admin.courses')); ?>" class="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 transition hover:border-cyan-300 hover:bg-cyan-50">
                ...
                <a href="<?php echo e(route('admin.report')); ?>" class="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 transition hover:border-cyan-300 hover:bg-cyan-50">
        ...
        <div class="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            ...
            <div class="mt-5 rounded-2xl border border-dashed border-slate-300 bg-slate-50 px-4 py-4 text-sm text-slate-500">
                Tổng khóa học public hiện có: <span class="font-semibold text-slate-900"><?php echo e($subjectCount); ?></span>
            </div>
        </div>
    </section>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XXamp\htdocs\khaitriedu\resources\views/dashboard_admin.blade.php ENDPATH**/ ?>