                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 text-center border border-gray-100 group-hover:-translate-y-2">
                        ...
                        <div class="mt-2 flex items-center justify-center gap-2 text-[10px] font-medium uppercase tracking-wider text-gray-400">
                            <span class="flex items-center gap-1">
                                <i class="fas fa-book-open"></i> <?php echo e($category->subjects_count); ?> môn
                            </span>
                            <span class="w-1 h-1 bg-gray-300 rounded-full"></span>
                            <span class="flex items-center gap-1 text-primary">
                                <i class="fas fa-graduation-cap"></i> <?php echo e($category->courses_count); ?> khóa
                            </span>
                        </div>
                    </div>
                </a>
                        ...
                        <div class="relative card bg-white rounded-2xl shadow-lg group-hover:shadow-2xl transition-all duration-300 overflow-hidden">
                            <div class="relative overflow-hidden h-56 bg-gradient-to-br from-blue-100 to-purple-100">
                                ...
                                <div class="absolute top-3 right-3">
                                    <div class="bg-gradient-to-r from-yellow-400 to-yellow-600 text-white text-xs font-bold px-4 py-1.5 rounded-full shadow-lg flex items-center gap-1">
                            ...
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-3 gap-2 mb-4 pb-4 border-b">
                                    ...
                                    <div class="text-center">
                                        <div class="text-lg font-bold text-primary">4.8⭐</div>
