...
<div class="space-y-6">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <a href="<?php echo e(route('admin.schedules.queue')); ?>" class="inline-flex items-center justify-center rounded-2xl bg-cyan-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-cyan-700">Hàng chờ xếp lịch</a>
    </div>

    <section class="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
        <form method="get" action="<?php echo e(route('admin.schedules.index')); ?>" class="grid gap-4 xl:grid-cols-5 xl:items-end">
            <div>
                ...
                <select name="teacher_id" class="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-2.5 text-sm focus:border-cyan-500 focus:outline-none">
                    ...
                    <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($teacher->id); ?>" <?php if(($filters['teacher_id'] ?? '') == $teacher->id): echo 'selected'; endif; ?>><?php echo e($teacher->name); ?></option>
            ...
            <div>
                ...
                <select name="student_id" class="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-2.5 text-sm focus:border-cyan-500 focus:outline-none">
                    ...
                    <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($student->id); ?>" <?php if(($filters['student_id'] ?? '') == $student->id): echo 'selected'; endif; ?>><?php echo e($student->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div>
                ...
                <select name="course_id" class="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-2.5 text-sm focus:border-cyan-500 focus:outline-none">
                    ...
                    <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($course->id); ?>" <?php if(($filters['course_id'] ?? '') == $course->id): echo 'selected'; endif; ?>><?php echo e($course->title); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div>
                <label class="text-sm font-medium text-slate-700">Ngày học</label>
                <input type="date" name="date" value="<?php echo e($filters['date'] ?? ''); ?>" class="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-2.5 text-sm focus:border-cyan-500 focus:outline-none">
            </div>
            <div class="flex gap-3">
                ...
                <a href="<?php echo e(route('admin.schedules.index')); ?>" class="inline-flex items-center justify-center rounded-2xl border border-slate-300 px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50">Đặt lại</a>
            </div>
        </form>
    </section>
            ...
            <article class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    <div>
                        ...
                        <h2 class="mt-2 text-xl font-semibold text-slate-900"><?php echo e($course->title); ?></h2>
                        <p class="mt-2 text-sm text-slate-600"><?php echo e($course->subject?->name ?? 'Chưa gắn khóa học public'); ?></p>
                    </div>
                    <span class="inline-flex rounded-full bg-cyan-50 px-3 py-1 text-xs font-semibold text-cyan-700"><?php echo e($course->statusLabel()); ?></span>
                </div>
                <div class="mt-5 grid gap-3 text-sm text-slate-600 md:grid-cols-2">
                    ...
                    <p><strong>Sĩ số:</strong> <?php echo e($course->scheduled_students_count); ?>/<?php echo e($course->capacity ?? 20); ?></p>
                    <p><strong>Ngày học:</strong> <?php echo e($course->dayLabel()); ?></p>
                </div>
                <div class="mt-5 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 text-sm text-slate-600">
                    ...
                    <div class="mt-3 flex flex-wrap gap-2">
                        <?php $__empty_2 = true; $__currentLoopData = $course->enrollments->whereIn('status', \App\Models\Enrollment::courseAccessStatuses()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                            <span class="inline-flex rounded-full bg-white px-3 py-1 text-xs font-medium text-slate-700 ring-1 ring-slate-200"><?php echo e($enrollment->user?->name ?? 'Học viên'); ?></span>
