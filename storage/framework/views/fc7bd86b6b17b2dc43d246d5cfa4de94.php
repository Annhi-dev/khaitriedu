<?php $__env->startSection('title', 'Lịch học của tôi'); ?>
  ...
  <div class="grid gap-4">
      ...
      <div class="rounded-3xl border border-gray-200 bg-white p-5 shadow-sm">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <h2 class="mt-1 text-xl font-bold text-gray-900"><?php echo e($enrollment->course->title); ?></h2>
            <div class="mt-3 grid gap-2 text-sm text-gray-600 md:grid-cols-2">
              <p><strong>Khóa học:</strong> <?php echo e($enrollment->course->subject->name ?? 'Chưa xác định'); ?></p>
              <p><strong>Giảng viên:</strong> <?php echo e($enrollment->assignedTeacher->name ?? 'Chưa phân công'); ?></p>
              <p><strong>Lịch học:</strong> <?php echo e($enrollment->course->formattedSchedule()); ?></p>
              <p><strong>Trạng thái:</strong> <span class="font-semibold text-green-700"><?php echo e($enrollment->statusLabel()); ?></span></p>
            </div>
          </div>
          <div class="flex items-center gap-3">
            <a href="<?php echo e(route('courses.show', $enrollment->course->id)); ?>" class="inline-flex items-center gap-2 rounded-xl bg-primary px-4 py-2.5 font-semibold text-white hover:bg-primary-dark transition">
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
      <div class="rounded-3xl border border-dashed border-gray-300 bg-white px-6 py-12 text-center">
        ...
        <a href="<?php echo e(route('courses.index')); ?>" class="mt-5 inline-flex items-center gap-2 rounded-xl bg-primary px-5 py-3 font-semibold text-white hover:bg-primary-dark transition">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XXamp\htdocs\khaitriedu\resources\views/student/schedule.blade.php ENDPATH**/ ?>