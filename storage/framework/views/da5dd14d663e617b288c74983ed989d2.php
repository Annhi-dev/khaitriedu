    ...
    <div id="coursesGrid" class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        <?php $__empty_1 = true; $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="relative group course-card"
                 data-title="<?php echo e(strtolower($course->name)); ?>"
                 data-category="<?php echo e(strtolower($course->category->slug ?? '')); ?>"
                 data-enrollments="<?php echo e($course->enrollments_count ?? 0); ?>"
                ...
                <div class="relative card bg-white rounded-3xl shadow-xl group-hover:shadow-2xl transition-all duration-300 overflow-hidden h-full flex flex-col">
                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        <div class="mb-4">
                            <h4 class="text-xl font-bold mb-2 line-clamp-2 text-gray-800 group-hover:text-primary transition"><?php echo e($course->name); ?></h4>
                            <p class="text-gray-600 text-sm line-clamp-3"><?php echo e($course->description ?? 'Khóa học được thiết kế linh hoạt để admin xếp lớp theo nhu cầu thực tế của học viên.'); ?></p>
                        </div>

                        <div class="grid grid-cols-2 gap-3 mb-5">
                            <div class="rounded-2xl bg-blue-50 p-4 text-center border border-blue-100">
                                <div class="text-2xl font-black text-primary"><?php echo e($course->enrollments_count ?? 0); ?></div>
                            ...
                            <div class="rounded-2xl bg-slate-50 p-4 text-center border border-slate-100">
                                <div class="text-2xl font-black text-slate-700"><?php echo e($course->courses_count ?? 0); ?></div>
