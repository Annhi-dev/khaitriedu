<?php $__env->startSection('title', 'Tuyển dụng - KhaiTriEdu'); ?>
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm hover:shadow-lg transition border-l-4 border-primary group">
                <div class="flex items-start justify-between">
                    <div>
                        <h3 class="text-xl font-bold text-gray-800 group-hover:text-primary transition">Vị trí <?php echo e($i); ?>: <?php echo e(['Giảng viên Python', 'Thiết kế UI/UX', 'Kỹ sư Backend', 'Chuyên viên Marketing', 'Quản lý Dự án'][rand(0,4)]); ?></h3>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XXamp\htdocs\khaitriedu\resources\views\pages\careers.blade.php ENDPATH**/ ?>