    ...
    <div class="relative min-h-screen lg:grid lg:grid-cols-[320px_minmax(0,1fr)]">
        <aside class="hidden min-h-screen border-r border-white/10 bg-slate-950 text-slate-100 lg:flex lg:flex-col">
            <div class="border-b border-white/10 px-7 py-7">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-4">
            ...
            <div class="flex-1 overflow-y-auto px-4 py-6">
                <?php $__currentLoopData = $menuSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mb-6 last:mb-0">
                        <p class="px-3 text-[11px] uppercase tracking-[0.3em] text-slate-500"><?php echo e($section['label']); ?></p>
                            ...
                            <?php $__currentLoopData = $section['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <a href="<?php echo e(route($item['route'])); ?>" class="<?php echo e($classes); ?>">
                                    <span class="flex items-center gap-3">
                                        <span class="flex h-10 w-10 items-center justify-center rounded-2xl <?php echo e($item['active'] ? 'bg-cyan-400/15 text-cyan-300' : 'bg-white/5 text-slate-400 group-hover:text-cyan-300'); ?>">
                                            <i class="<?php echo e($item['icon']); ?> text-sm"></i>
                                        </span>
                ...
                <div class="overflow-hidden rounded-[32px] border border-white/50 bg-white/75 shadow-[0_20px_80px_rgba(15,23,42,0.08)] backdrop-blur-xl">
                    <div class="flex flex-col gap-4 border-b border-slate-200/80 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <h2 class="mt-1 text-2xl font-extrabold text-slate-950"><?php echo e($pageTitle); ?></h2>
                            </div>
                        </div>
                        <div class="flex flex-wrap items-center gap-3">
                            <div class="rounded-2xl bg-slate-950 px-4 py-3 text-sm text-slate-200 shadow-lg shadow-slate-950/10">
                                ...
                                <p class="mt-1 font-semibold text-white"><?php echo e($adminUser?->name ?? 'Admin'); ?></p>
                            </div>
                            <a href="<?php echo e(route('logout')); ?>" class="inline-flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50">
                    ...
                    <div class="flex flex-col gap-3 px-4 py-3 text-sm text-slate-500 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
                        <div class="flex flex-wrap items-center gap-2">
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="font-semibold text-slate-700 hover:text-slate-950">Admin</a>
                            <?php if (! (request()->routeIs('admin.dashboard'))): ?>
                                <span>/</span>
                                <span class="text-slate-600"><?php echo e($pageTitle); ?></span>
                            <?php endif; ?>
                        </div>
                        <p class="text-xs uppercase tracking-[0.25em] text-slate-400"><?php echo e(now()->format('d/m/Y H:i')); ?></p>
                    </div>
                </div>
            </header>
        ...
        <aside x-show="sidebarOpen" x-cloak class="fixed inset-y-0 left-0 z-50 w-80 overflow-y-auto bg-slate-950 px-4 py-5 text-slate-100 shadow-2xl lg:hidden">
            ...
            <?php $__currentLoopData = $menuSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mb-6 last:mb-0">
                    ...
                    <nav class="mt-3 space-y-1.5">
                        <?php $__currentLoopData = $section['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route($item['route'])); ?>" class="flex items-center gap-3 rounded-2xl px-3 py-3 text-sm font-semibold <?php echo e($item['active'] ? 'bg-white/10 text-white' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?>">
                                <span class="flex h-10 w-10 items-center justify-center rounded-2xl <?php echo e($item['active'] ? 'bg-cyan-400/15 text-cyan-300' : 'bg-white/5 text-slate-400'); ?>">
                                    <i class="<?php echo e($item['icon']); ?> text-sm"></i>
                                </span>
                                <span><?php echo e($item['label']); ?></span>
                            </a>
...
</html><?php /**PATH D:\XXamp\htdocs\khaitriedu\resources\views/layouts/admin.blade.php ENDPATH**/ ?>