            ...
            <nav class="mt-3 space-y-1">
                <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if(!empty($item['disabled'])): ?>
                        <div class="<?php echo e($classes); ?> cursor-not-allowed opacity-60">
                            <span class="flex items-center gap-3">
                                <i class="<?php echo e($item['icon']); ?> w-5 text-center"></i>
                                <span><?php echo e($item['label']); ?></span>
                            </span>
                            <span class="rounded-full border border-white/10 px-2 py-0.5 text-[11px] uppercase tracking-wide text-slate-400"><?php echo e($item['note']); ?></span>
                        </div>
                    <?php else: ?>
        ...
        <header class="border-b border-slate-200 bg-white/90 backdrop-blur">
            <div class="flex items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <h2 class="text-xl font-semibold text-slate-900"><?php echo e($pageTitle); ?></h2>
                    </div>
                </div>
                <div class="flex items-center gap-3">
                    <div class="hidden rounded-2xl border border-slate-200 bg-slate-50 px-4 py-2 text-right sm:block">
                        ...
                        <p class="text-sm font-medium text-slate-700"><?php echo e($adminUser?->name ?? 'Admin'); ?></p>
                    </div>
                    <a href="<?php echo e(route('logout')); ?>" class="inline-flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-100">
            ...
            <div class="border-t border-slate-100 px-4 py-3 text-sm text-slate-500 sm:px-6 lg:px-8">
                <div class="flex flex-wrap items-center gap-2">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="font-medium text-slate-600 hover:text-slate-900">Dashboard</a>
