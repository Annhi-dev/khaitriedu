            ...
            <form method="post" action="<?php echo e(route('admin.courses.update', $course->id)); ?>" class="mt-5 grid gap-4">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input name="schedule" value="<?php echo e($course->schedule); ?>" placeholder="Ví dụ: T2-T4-T6, 18:00-20:00" class="w-full rounded-2xl border border-slate-300 px-4 py-3 text-sm text-slate-900 focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-100" />
                    </div>
                </div>
                <div>
