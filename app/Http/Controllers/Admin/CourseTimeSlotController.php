...
class CourseTimeSlotController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.course_time_slots.index', compact('current', 'filters', 'timeSlots', 'summary') + $this->formOptions());
    }
    ...
    public function create()
    {
        ...
        return view('admin.course_time_slots.create', [
            'current' => $current,
    ...
    public function edit(CourseTimeSlot $courseTimeSlot)
    {
        ...
        return view('admin.course_time_slots.edit', compact('current', 'courseTimeSlot') + $this->formOptions());
    }
