...
class NotificationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('thong_bao.index', [
            ...
            'openRouteName' => 'student.notifications.show',
            'emptyMessage' => 'Chưa có thông báo nào gửi đến bạn.',
    ...
    public function show($notification)
    {
        ...
        return view('thong_bao.show', [
            ...
            'pageEyebrow' => 'Thông báo',
            'backRoute' => route('student.notifications.index'),
    ...
    private function notificationPayload(NguoiDung $user): array
    {
        ...
        return [
            ...
            'notifications' => $notifications->map(fn (ThongBao $notification) => [
                ...
                'open_url' => route('student.notifications.show', $notification),
            ])->values(),
        ];
    }
}
