...
class StudentScheduleExperienceTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_student_schedule_displays_attendance_summary_and_classmates(): void
    {
        ...
        $response->assertSee('Thong ke diem danh');
        $response->assertSee('Ty le co mat');
    ...
    private function createClassBundle(User $teacher): array
    {
        ...
        $course = Course::create([
            ...
            'schedule' => 'Thu 5, 18:00 - 20:00 | Tu 01/04/2026 den 01/06/2026',
        ]);
