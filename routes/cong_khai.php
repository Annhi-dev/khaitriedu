...
require base_path('routes/xac_thuc.php');
Route::prefix('student')->name('student.')->middleware('student')->group(base_path('routes/hoc_vien.php'));
Route::prefix('teacher')->name('teacher.')->middleware('teacher')->group(base_path('routes/giao_vien.php'));
Route::prefix('admin')->name('admin.')->middleware('admin')->group(base_path('routes/quan_tri.php'));
